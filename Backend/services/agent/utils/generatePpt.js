...
export const generatePPT = async (data) => {
    ...
    const addCover = (ppt,data) => {
        const slides  = ppt.addSlide()
    
        slides.background = {
            color:COLORS.primary
        }

        slides.addShape(ppt.ShapeType.rect,{
            x:0,
            y:0,
            w:13.33,
            h:0.18,
        ...
        slides.addText("Generated By AvniLLM", {
        x: 0,
        y: 6.9,
        w: 13.3,
        h: 0.2,
...
const addThankYou = (ppt) => {
        ...
        slide.addText(`Generated By AvniLLM`, {
        x: 0,
        y: 6.9,
        w: 13.33,
        h: 0.2,
