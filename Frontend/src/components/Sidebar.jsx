...
import { setConversations, setSelectConversation } from "../redux/conversationSlice";
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2.5 px-4 py-4 border-b border-white/[0.06]">
        ...
        <span className="text-[16px] font-semibold text-slate-100 tracking-tight flex-1">AvniLLM</span>
